...
#End Region
    ...
    Private Sub Form_Splash_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        AgentInformation.AppVersion = "LoginProg-30.5"
    ...
    Public Function SetupwsClient() As Boolean
        SetupwsClient = False
        Try
            'Write_Log("", "SetupwsClient(Start) nLine:" & CallInformation.nLine & ", UseNativeWS=" & Configurations.UseNativeWS)
    ...
    Private Sub IVR_TPINVerify(cmd As String)
        Try
            ...
            If MakeTPINResponse = True Then
                ...
                If Not _TerminalServerSession Then
                    ovsControl.media_play(New ovsPSProPhony.TControl.media_play_Args(0, 0, CallInformation.nLineSessionID1, False, "\Sounds\" & sLanguage & "\TPINVerifyed.wav", True, "A"))
                End If
...
GetTPIN2Again:
    ...
    Private Sub NotifyIcon1_DoubleClick(sender As Object, e As EventArgs) Handles NotifyIcon1.DoubleClick
        Try
            If Configurations.bDisableTrayICON = False Then
                Write_Log("", "NotifyIcon1_DoubleClick(Configurations.bDisableTrayICON) is false")
                Exit Sub
            End If
    ...
    Private Sub processCheckNewEvents(timenow As String)
        Try
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Write_Log("ERR", "processCheckNewEvents Exception 1:" & ex.Message)
            End Try
            If Trim(MSG) = "" Then
                Exit Sub
            End If
...
#Region "Events_NWSS"
    ...
    '        wsMessages.Add("OnOpen~~~" & iCount & "~~~" & "~~~" & e.sKey)
    ...
    '    Try
    '        'Console.WriteLine("Data Received From [" & e.sKey & "] - " + e.sData)
    '        If Trim(e.sData) <> "" Then
    '            wsMessages.Add("OnMessage~~~" & e.sKey & "~~~" & e.sData & "~~~" & e.sKey)
    '        End If
    '    Catch ex As Exception
    '        Write_Log("", "wSSNativeHost_Event_Data(Error) " & ex.Message)
    '        'Console.WriteLine("wSSNativeHost_Event_Data(Error) " & ex.Message.ToString())
    '    End Try
    'End Sub
    ...
    '        'Write_Log("", "wSSNativeHost_Event_Disconnection(" & iCount & ") CountBefore=" & iCount & ", CountAfter=" & iCount & ", Key=" & e.sKey)
    '    Catch ex As Exception
    '        Write_Log("", "wSSNativeHost_Event_Disconnection(Error) " & ex.Message)
    '        'Console.WriteLine("wSSNativeHost_Event_Disconnection(Error) " & ex.Message.ToString())
    '    End Try
    'End Sub
