...
'    Public ReadOnly Property Playing(Optional ChannelNo As Integer = 0) As Boolean
'        Get
'            Try
'                Return _Channel(ChannelNo)._Playing
...
'            Dim rt As Integer = 0
'            sendGenericEvent(ChannelNo, -1, "onInviteRecord", sessionID, "enableAudioStreamCallback(" & rt & ")", "Start, enable=" & enable)
'            rt = _Channel(ChannelNo)._sdkLib.enableAudioStreamCallback(ChannelNo, sessionID, enable, _Recording_CALLBACK_MODE)
'            sendGenericEvent(ChannelNo, -1, "onInviteRecord", sessionID, "enableAudioStreamCallback(" & rt & ")", "End, enable=" & enable)
'            Return True
'        Catch ex As Exception
...
'        Try
'            sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Enter")
'            Try
'                _Channel(callbackIndex)._stopPlaying = True
'                _Channel(callbackIndex)._Playing = False

'                If Not IsNothing(_Channel(callbackIndex).Thread_Media_Player) Then
'                    sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Thread_Media_Player:" & "not nothing")
'                    If _Channel(callbackIndex).Thread_Media_Player.ThreadState = Threading.ThreadState.Running Then
'                        sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Thread_Media_Player:" & "is running")
'                        _Channel(callbackIndex).Thread_Media_Player.Abort()
'                        _Channel(callbackIndex).Thread_Media_Player = Nothing
'                    End If
'                End If
'                sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Thread_Media_Player:" & "Here to stop")
'                _Channel(callbackIndex)._sdkLib.stopPlayAudioFileToRemote(sessionID)
'                sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Thread_Media_Player:" & "Here to stop done")
'            Catch ex As Exception
'                sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Exception0:" & ex.Message)
'            End Try
'            media_stopPlay = "Stop"
'            sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Exit")
'        Catch ex As Exception
'            sendGenericEvent(callbackIndex, callbackObject, "media_stopPlay", sessionID, "", "Exception1:" & ex.Message)
...
'        media_play = ""
'        sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "Enter")

'        Try
'            If _Channel(e._callbackIndex)._Playing = True Then
'                sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName & "|" & e._szStopTone, "Exception:" & "Already Playing File(s)")
...
'                    sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "Thread_Media_Player:" & "not nothing")
'                    If _Channel(e._callbackIndex).Thread_Media_Player.ThreadState = Threading.ThreadState.Running Then
'                        sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "Thread_Media_Player:" & "is running")
'                        _Channel(e._callbackIndex)._stopPlaying = True
...
'                        sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "Thread_Media_Player:" & "Stop sent")
'                    End If
'                End If
'            Catch ex As Exception
'                sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "Exception0:" & ex.Message)
'                'Console.WriteLine("Exception" & ex.Message)
'            End Try
'            If e._callAsync Then
'                _Channel(e._callbackIndex)._Playing = True
'                sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "its async call")
...
'                sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "Thread_Media_Player started")
'            Else
'                sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "its sync call")
'                thMedia_Player(e)
'                sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "its call done")
'            End If
'            Return "Started"
'        Catch ex As Exception
'            media_play = "Failed-" & ex.Message
'            sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, e._szFileName, "Exception1:" & ex.Message)
...
'                Dim rt As Integer = 0
'                If value = -1 Then
'                    rt = _Channel(ChannelNo)._sdkLib.disableSessionTimer
'                    Return
'                Else
'                    rt = _Channel(ChannelNo)._sdkLib.enableSessionTimer(value, SESSION_REFRESH_MODE.SESSION_REFERESH_UAC)
'                    rt = _Channel(ChannelNo)._sdkLib.enableSessionTimer(value, SESSION_REFRESH_MODE.SESSION_REFERESH_UAS)
'                End If
...
'        Get
'            Try
'                Dim x = _Channel(0)._sdkLib.getNICNums()
'                Return x
'            Catch ex As Exception
'                NICCount = 0
...
'                '' SP  = 0 
'                '' IVR = 1
'                rt = _Channel(ChannelNo)._sdkLib.initialize(_Channel(ChannelNo)._Transport, _localIPAddress, _Channel(ChannelNo)._LocalPort, _logLevel, _FoldersLog, _Channel(ChannelNo)._MAX_LINES, _Channel(ChannelNo)._UserAgentName, _coreMode, 1, "\", "", False)
'            Catch ex As Exception
...
'        Return 0
'    End Function
'    Friend Function onReceivedRefer(callbackIndex As Integer, callbackObject As Integer, ByVal sessionId As Int32, ByVal referId As Int32, ByVal [to] As [String], ByVal from As [String],
'    ByVal referSipMessage As StringBuilder) As Int32 Implements SIPCallbackEvents.onReceivedRefer
'        'Call_refer = False
'        Dim rt As Integer = 0
'        Try
'            sendGenericEvent(callbackIndex, callbackObject, "onReceivedRefer", sessionId, "referId:" & referId, "to:" & [to].ToString() & ", from:" & from.ToString)
'            rt = _Channel(callbackIndex)._sdkLib.acceptRefer(referId, referSipMessage.ToString)
'            If rt = 0 Then
'                sendGenericEvent(callbackIndex, callbackObject, "onReceivedRefer", sessionId, "rt:" & rt.ToString, "Accepted")
'            Else
'                sendGenericEvent(callbackIndex, callbackObject, "Error:onReceivedRefer", sessionId, "rt:" & rt.ToString, "")
'            End If
'        Catch ex As Exception
'            'RaiseError(callbackIndex, -1, sessionId, New Exception("onReceivedRefer(" & callbackIndex & ") " & ex.Message))
'            sendGenericEvent(callbackIndex, callbackObject, "Error:onReceivedRefer", sessionId, ex.Message, "")
...
'    'ATIF  START
'    Public Function Call_refer(ChannelNo As Integer, sessionID As Long, ext As String) As Boolean
'        Call_refer = False
'        Dim rt As Integer = 0
'        Try
'            Call_StopRecord(ChannelNo, sessionID)
'            rt = _Channel(ChannelNo)._sdkLib.refer(sessionID, ext)
'            If rt <> 0 Then
'                RaiseError(ChannelNo, -1, sessionID, New Exception("Call_refer(" & ChannelNo & ") Error:" & " failed with error (" & rt & ") sessionID:" & sessionID & " ext:" & ext))
'                Exit Function
'            End If
'            sendGenericEvent(ChannelNo, -1, "onInviteClosed", sessionID, "Call_refer", "")
'            Call_refer = True
'        Catch ex As Exception
'            RaiseError(ChannelNo, -1, sessionID, New Exception("Call_refer(" & ChannelNo & ") " & ex.Message))
'        End Try
'    End Function

'    'ATIF  END

'    Friend Function onReferAccepted(callbackIndex As Integer, callbackObject As Integer, ByVal sessionId As Int32) As Int32 Implements SIPCallbackEvents.onReferAccepted
...
'    Public Function Call_Make(ChannelNo As Integer, NumberToCall As String, Optional videoCall As Boolean = False, Optional transfer As Boolean = False) As Boolean
'        Call_Make = False
...
'            Dim videoRecordFileFormat As VIDEOCODEC_TYPE = VIDEOCODEC_TYPE.VIDEO_CODE_NONE

'            _Channel(ChannelNo)._recFileName = sfilePath & sfileName & ".wav"
'            Dim isError As Boolean = False
'            Dim ErrorDescriptions As String = ""
...
'                If rt <> 0 Then
'                    isError = True
'                    ErrorDescriptions = "" & "Call_StartRecord(" & ChannelNo & ") Error:" & " failed with error (" & rt & ") sessionID:" & sessionID
'                    RaiseError(ChannelNo, -1, sessionID, New Exception(ErrorDescriptions))
'                    'Exit Function
'                End If
'                sendGenericEvent(ChannelNo, -1, "onInviteRecord", sessionID, "Started-file", sfilePath & sfileName & ", isError=" & isError & ", ErrorDescription=" & ErrorDescriptions)
'            Else
...
'        End Try
'    End Function
'    Public Function Call_CreateAudioConference(ChannelNo As Integer, sessionID As Long, tsessionID As Long) As Boolean
'        Call_CreateAudioConference = False
'        Dim rt As Integer = 0
'        Try
'            rt = _Channel(ChannelNo)._sdkLib.createAudioConference()
'            If rt <> 0 Then
'                RaiseError(ChannelNo, -1, sessionID, New Exception("Call_Hangup(" & ChannelNo & ") Error:" & " failed with error (" & rt & ") sessionID:" & sessionID))
'                Exit Function
'            End If
'            _Channel(ChannelNo)._sdkLib.joinToConference(sessionID)
'            _Channel(ChannelNo)._sdkLib.joinToConference(tsessionID)
'            sendGenericEvent(ChannelNo, -1, "onAudioConferenceCreated", sessionID, "Byuser", "")
'            Call_CreateAudioConference = True
'        Catch ex As Exception
'            RaiseError(ChannelNo, -1, sessionID, New Exception("Call_CreateAudioConference (" & ChannelNo & ") " & ex.Message))
'        End Try
'    End Function
'    Public Function Call_Transfer(ChannelNo As Integer, sessionID As Long, tsessionID As Long, ext As String) As Boolean
'        Call_Transfer = False
'        Dim rt As Integer = 0
'        Try
'            Call_StopRecord(ChannelNo, sessionID)
'            rt = _Channel(ChannelNo)._sdkLib.attendedRefer(sessionID, tsessionID, ext)
'            If rt <> 0 Then
'                RaiseError(ChannelNo, -1, sessionID, New Exception("Call_Transfer(" & ChannelNo & ") Error:" & " failed with error (" & rt & ") sessionID:" & sessionID & " tsessionID:" & tsessionID & " ext:" & ext))
'                Exit Function
'            End If
'            sendGenericEvent(ChannelNo, -1, "onInviteClosed", sessionID, "Byuser", "")
'            Call_Transfer = True
'        Catch ex As Exception
'            RaiseError(ChannelNo, -1, sessionID, New Exception("Call_Transfer(" & ChannelNo & ") " & ex.Message))
'        End Try
'    End Function
...
'' Above all is old code, new code is taken from not working folder version.
    ...
    Friend Function thMedia_Player(e As media_play_Args) As Boolean
        ...
        Try
            ...
            For index = 0 To _fileNames.Length - 1
                ...
                szWAVFileName = szWAVFileName.Replace("\\", "\")
                szWAVFileName = szWAVFileName.Replace("\\\", "\")

                If File.Exists(szWAVFileName) = False Then
                    sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, szWAVFileName, "Exception:" & "File not found")
                    retVal = 1
                    GoTo NextFile
                End If
                Dim exMessage As String = ""
                Try
                    sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, szWAVFileName, "Playing")
                    retVal = _Channel(e._callbackIndex)._sdkLib.playAudioFileToRemote(e._sessionID, szWAVFileName.Replace("\", "//"), 16000, False)
                    If retVal <> 0 Then
                        sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, szWAVFileName, "Exception:retVal=" & retVal.ToString())
                        GoTo NextFile
                    Else
                        sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, szWAVFileName, "Played")
                    End If
                Catch ex As Exception
                    exMessage = ex.Message
                    retVal = 1000
                    sendGenericEvent(e._callbackIndex, e._callbackObject, "media_play", e._sessionID, szWAVFileName, "Exception:" & exMessage)
                    GoTo NextFile
                End Try
                _Channel(e._callbackIndex)._currentFilePlayed = False
                retVal = 0
                ...
                End While
NextFile:
                sendGenericEvent(e._callbackIndex, e._callbackObject, "onPlayAudioFileProgress", e._sessionID, _FoldersVoice & "\" & _FileName, "[" & index & "/" & _fileNames.Length - 1 & "]")
                Select Case retVal
                    Case -1 ' blank File name ignore
                    Case 0 ' keep playing
                    Case 1 ' file not found
        ...
        Catch ex As Exception
            _Channel(e._callbackIndex)._Playing = False
            RaiseError(e._callbackIndex, e._callbackObject, e._sessionID, New Exception("thMedia_Player(" & e._callbackIndex & ") " & " szWAVFileName (" & szWAVFileName & ")" & "failed with error (" & ex.Message & ")"))
        End Try
        _Channel(e._callbackIndex)._Playing = False
...
#Region "Call related Functions"
    Public Function Call_Make(ChannelNo As Integer, NumberToCall As String, Optional videoCall As Boolean = False, Optional transfer As Boolean = False) As Boolean
        ...
        sessionId = _Channel(ChannelNo)._sdkLib.call(NumberToCall, _Channel(ChannelNo)._SDP, videoCall)
        If sessionId <= 0 Then
            RaiseError(ChannelNo, -1, sessionId, New Exception("Call_Make(" & ChannelNo & ") Error:" & " failed with error (" & sessionId & ") sessionID:" & sessionId))
            Return False
        End If
    ...
    Public Function Call_SendDTMF(ChannelNo As Integer, sessionID As Long, Digit As Integer, Optional DTMFMETHOD As Integer = 0, Optional ToneDuration As Integer = 160, Optional PlayTone As Boolean = True) As Boolean
        Call_SendDTMF = False
        Dim rt As Integer = 0
        Try
            rt = _Channel(ChannelNo)._sdkLib.sendDtmf(sessionID, IIf(DTMFMETHOD = 0, DTMF_METHOD.DTMF_RFC2833, DTMF_METHOD.DTMF_INFO), Digit, ToneDuration, PlayTone)
            If rt <> 0 Then
                RaiseError(ChannelNo, -1, sessionID, New Exception("Call_SendDTMF(" & ChannelNo & ") Error:" & " failed with error (" & rt & ") sessionID:" & sessionID))
                Exit Function
            End If
            Call_SendDTMF = True
        Catch ex As Exception
            RaiseError(ChannelNo, -1, sessionID, New Exception("Call_SendDTMF(" & ChannelNo & ") " & ex.Message))
        End Try
    End Function
